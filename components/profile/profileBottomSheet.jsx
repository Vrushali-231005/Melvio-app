  ...
  return (
    <Modal transparent animationType="slide">
      <View className="flex-1 justify-end bg-black/40">
        <View className="bg-light-bg dark:bg-dark-card rounded-t-[30px] p-6">
          <Text className="text-xl font-bold text-light-primary dark:text-dark-primary mb-4">{title}</Text>
          ...
          <Pressable
            onPress={close}
            className="bg-light-primary dark:bg-dark-primary p-4 rounded-xl mt-4"
          >
